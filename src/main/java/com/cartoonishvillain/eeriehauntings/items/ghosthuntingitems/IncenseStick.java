...
public class IncenseStick extends Item {
    ...
    public ActionResult<ItemStack> use(World p_41432_, PlayerEntity p_41433_, Hand p_41434_) {
        if(p_41433_.getMainHandItem().getItem() instanceof IncenseStick && p_41433_.getOffhandItem().getItem().equals(Items.FLINT_AND_STEEL) && !p_41432_.isClientSide()){
            ...
            p_41432_.playSound(null, p_41433_.blockPosition(), SoundEvents.BLAZE_SHOOT, SoundCategory.PLAYERS, 1, 1);
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable World p_41422_, List<ITextComponent> p_41423_, ITooltipFlag p_41424_) {
        if(!EerieHauntings.serverConfig.EASYMODE.get()) {
            p_41423_.add(new TranslationTextComponent("tools.eeriehauntings.incense").withStyle(TextFormatting.GOLD));
        }else {
            p_41423_.add(new TranslationTextComponent("tools.eeriehauntings.easyincense").withStyle(TextFormatting.GOLD));
        }
