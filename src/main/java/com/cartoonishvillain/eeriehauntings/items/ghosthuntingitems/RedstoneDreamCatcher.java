...
public class RedstoneDreamCatcher extends Item {
    ...
    public ActionResult<ItemStack> use(World p_41432_, PlayerEntity p_41433_, Hand p_41434_) {
        if(p_41433_.getMainHandItem().getItem() instanceof RedstoneDreamCatcher && !p_41432_.isClientSide()){
            ...
            p_41432_.playSound(null, p_41433_.blockPosition(), SoundEvents.PISTON_CONTRACT, SoundCategory.PLAYERS, 0.5f, 1);
            p_41432_.playSound(null, p_41433_.blockPosition(), SoundEvents.PISTON_EXTEND, SoundCategory.PLAYERS, 0.5f, 1);
            ...
            p_41433_.getCapability(PlayerCapability.INSTANCE).ifPresent(h->{
                ...
                if(h.getIsHaunted()){
                    if(!EerieHauntings.serverConfig.EASYMODE.get()) {
                        ...
                        ForgeBusEvents.exorciseGhost((ServerPlayerEntity) p_41433_);
                    }
                }
            });
        }
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable World p_41422_, List<ITextComponent> p_41423_, ITooltipFlag p_41424_) {
        if(!EerieHauntings.serverConfig.EASYMODE.get())
            p_41423_.add(new TranslationTextComponent("tools.eeriehauntings.redstone").withStyle(TextFormatting.GOLD));
        else
            p_41423_.add(new TranslationTextComponent("tools.eeriehauntings.easyredstone").withStyle(TextFormatting.GOLD));
